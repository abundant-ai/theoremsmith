...
class Config:
    ...
    def load() -> "Config":
        return Config(
            ...
            base_url=os.getenv("THEOREMSMITH_BASE_URL", "https://api.moonshot.ai/v1").rstrip("/"),
            api_key=os.getenv("THEOREMSMITH_API_KEY", ""),
            model=os.getenv("THEOREMSMITH_MODEL", "kimi-k2-0905-preview"),
